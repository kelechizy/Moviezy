...
public class IntroPageTransformer implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
        ...
        ImageView image1 = (ImageView) page.getRootView().findViewById(R.id.image1);
        ImageView image2 = (ImageView) page.getRootView().findViewById(R.id.image2);
        ImageView image3 = (ImageView) page.getRootView().findViewById(R.id.image3);
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            image2.setTranslationX(position * (pageWidth / 2));
