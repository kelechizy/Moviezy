...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        // content://com.example.android.sunshine.app/movie/94074
        type = mContext.getContentResolver().getType(
                MovieEntry.buildMovieId(testMovieId));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
    ...
    public void testBasicMovieQueries() {
        ...
        ContentValues testValues = TestUtilities.createSampleMovieValues();
        long movieRowId = TestUtilities.insertSanAndreasMovieValues(mContext);
    ...
    public void testUpdateLocation() {
        ...
        ContentValues values = TestUtilities.createSampleMovieValues();
    ...
    public void testInsertReadProvider() {
        ...
        ContentValues weatherValues = TestUtilities.createSampleMovieValues(movieRowId);
    ...
    static ContentValues[] createBulkInsertMovieValues() {
        String currentTestDate = TestUtilities.TEST_DATE_STRING;
        ContentValues[] returnContentValues = new ContentValues[BULK_INSERT_RECORDS_TO_INSERT];

        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++) {
            ContentValues movieValues = new ContentValues();
            movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_ID, i);
            movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_DATE, currentTestDate);
            movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_TITLE, "Sample " + i);
            movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_OVERVIEW, 1.2 + 0.01 * (float) i);
            movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_POSTER, 1.3 - 0.01 * (float) i);
            movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_BACKDROP, 75 + i);
            movieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_VOTE, 65 - i);
    ...
    public void testBulkInsert() {
        ...
        cursor = mContext.getContentResolver().query(
                ...
                null, // cols for "where" clause
                null, // values for "where" clause
                MovieEntry.COLUMN_MOVIE_DATE + " ASC"  // sort order == by DATE ASCENDING
        );
